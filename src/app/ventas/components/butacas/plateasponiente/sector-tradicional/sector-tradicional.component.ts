...
@Component({
  selector: 'app-sector-tradicional',
  templateUrl: './sector-tradicional.component.html',
  styleUrls: ['./sector-tradicional.component.css']
})
export class SectorTradicionalComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    await this.api.metodo('butacasByZona/TRADICIONAL1','GET','',{})?.subscribe((data:any)=>{
